...
pub fn spawn(commands: &mut Commands, meshes: &MeshAssets, materials: &MaterialAssets) {
    ...
    super::super::spawn_enemy_group(commands, meshes, materials, Vec3::new(-0.8, 0.0, 40.0), 28);
    super::super::spawn_gate(
        commands,
        meshes,
        materials,
    ...
    super::super::spawn_enemy_group(commands, meshes, materials, Vec3::new(0.8, 0.0, 64.0), 34);
    super::super::spawn_gate(
        commands,
        meshes,
        materials,
    ...
    super::super::spawn_enemy_group(commands, meshes, materials, Vec3::new(0.0, 0.0, 88.0), 38);
    super::super::spawn_moving_obstacle(
        commands,
        meshes,
        materials,
